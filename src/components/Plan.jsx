  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='grid grid-cols-2 grid-rows-6 h-[80vh]'>
        ...
        <img className='row-span-2 object-cover w-full h-full p-2' src="https://images.unsplash.com/photo-1515238152791-8216bfdf89a7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8caraMHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1772&q=80" alt="/" />
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <p className='text-2xl py-6'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ullam, repudiandae.</p>
        <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus quod reiciendis nostrum consequatur repellendus vel, id modi ex. Aspernatur sint blanditiis minima aperiam eos at totam facere repellat hic nam.</p>
        <div>
